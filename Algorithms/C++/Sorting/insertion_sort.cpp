...
static void create_random_array(T *arr, int N)
{
    while (N--)
    {
        double r = (rand() % 10000 - 5000) / 100.f;
...
void tests()
{
    ...
    assert(is_sorted(arr1, arr1 + 10));
    cout << "passed" << endl;

    int arr2[5] = {5, -3, 7, -2, 1};
    cout << "Test 2... ";
    sorting::insertionSort(arr2, 5);
    assert(is_sorted(arr2, arr2 + 5));
    cout << "passed" << endl;

    float arr3[5] = {5.6, -3.1, -3.0, -2.1, 1.8};
    cout << "Test 3... ";
    sorting::insertionSort(arr3, 5);
    assert(is_sorted(arr3, arr3 + 5));
    cout << "passed" << endl;

    vector<float> arr4({5.6, -3.1, -3.0, -2.1, 1.8});
    cout << "Test 4... ";
    sorting::insertionSort(&arr4);
    assert(is_sorted(begin(arr4), end(arr4)));
    cout << "passed" << endl;
...
int main()
{
    ...
    size_t n;
    cout << "Enter the length of your array (0 to exit): ";
    cin >> n;
    if (n == 0)
    {
        return 0;
